%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Measurement of Cobra Geometry Parameters and Motor Map [Daytime]}\label{secflow:CobraCal}
...
We estimate 1--2 days for calibration of all the cobra parameters and motor map.
