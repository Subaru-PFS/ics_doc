...
From the viewpoint of software, this process opportunity  to demonstrate the ``callback" function, with which the IIC sends a signal to Gen2 to move the telescope at a given condition.
